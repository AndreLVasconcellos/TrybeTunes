  ...
  render() {
    ...
    return (
      <div data-testid="page-search" className="flex">
        ...
        >
          <section
            className="h-1/6 border-b-2 border-b-white p-3 flex
          ...
          >
            <form className="flex">
              ...
              rounded-2xl p-2 text-white w-max bg-sky-300"
                  >
                    Pesquisar
                  </button>
                </>
                  ...
                  {arrayArtist.map((element) => (
                    ...
                    >
                      <img
                        ...
                        className="flex items-center text-right mt-5
                        justify-center w-40 h-40"
                      />
